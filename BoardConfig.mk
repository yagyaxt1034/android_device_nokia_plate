...
BOARD_KERNEL_CMDLINE += ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 vmalloc=350M ro.androidboot.selinux=permissive
...
TARGET_KERNEL_CONFIG := FIH_msm8937-perf_defconfig
...
BOARD_CACHEIMAGE_PARTITION_SIZE := 268435456      #   253920 * 1024 mmcblk0p52
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 67108864    #    65536 * 1024 mmcblk0p38
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 5132779520    #  3428080 * 1024 mmcblk0p53
BOARD_USERDATAIMAGE_PARTITION_SIZE := 24356306432  # 25782252 * 1024 mmcblk0p54
