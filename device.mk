...
PRODUCT_COPY_FILES +=  \
    ...
    $(LOCAL_PATH)/audio/audio_platform_info_ple.xml:system/vendor/etc/audio_platform_info_ple.xml \
    $(LOCAL_PATH)/audio/audio_policy.conf:system/vendor/etc/audio_policy.conf \
    $(LOCAL_PATH)/audio/mixer_paths.xml:system/vendor/etc/mixer_paths.xml \
    $(LOCAL_PATH)/audio/mixer_paths_ple.xml:system/vendor/etc/mixer_paths_ple.xml \
